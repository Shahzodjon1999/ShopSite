...
if (builder.Environment.IsDevelopment()){
    ...
    builder.Services.AddDbContext<CatalogContext>(options =>
        options.UseMySql(builder.Configuration.GetConnectionString("CatalogConnection"),
        ServerVersion.AutoDetect(builder.Configuration.GetConnectionString("CatalogConnection"))));
